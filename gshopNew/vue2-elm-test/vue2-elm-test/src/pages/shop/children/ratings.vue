  ...
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      <div class="overview">
        ...
        <div class="overview-right">
          <div class="score-wrapper">
            ...
            <Star :starNum="4.6" :starSize="36" />
            <span class="score">{{info.serviceScore}}</span>
          </div>
          <div class="score-wrapper">
            <span class="title">商品评分</span>
            <Star :starNum="4.7" :starSize="36" />
      ...
      <div class="ratingselect">
        ...
        <div class="switch" :class="{on:contentHas}">
          <span class="iconfont icon-check_circle" @click="content()"></span>
...
export default {
  ...
  computed: {
    ...
    filterRatings() {
      const { selectType, ratings, contentHas } = this;
      const arr=[];
      ratings.forEach(rating => {
        const { text, rateType } = rating;
        if((selectType==2)|| (selectType===rateType) && (!contentHas || text.length>0)){
          arr.push(rating)
           console.log(arr)
        }
      });
    ...
    // filterRatings() {
    //   // 得到相关的数据
    //   const { ratings, contentHas, selectType } = this;
    ...
    //     // return selectType === 2;
    //     return (selectType===2) || (selectType===rateType) && (!contentHas || text.length>0)
    //   });
    // }
  },
  components: {
  ...
  methods: {
    ...
    content() {
      this.contentHas = !this.contentHas;
    }
  }
};
</script>
